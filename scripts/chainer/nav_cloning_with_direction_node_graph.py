...
class nav_cloning_node:
    def __init__(self):
        ...
        self.nav_start_service = rospy.Service('/nav_start', Trigger, self.callback_nav_start)
#        self.pose_sub = rospy.Subscriber("/amcl_pose", PoseWithCovarianceStamped, self.callback_pose)
        ...
        self.load_path = roslib.packages.get_pkg_dir('nav_cloning') + '/data/model_with_dir_'+str(self.mode)+'/20221111_02:33:55_times9_GOD/model.net'
    ...
    def callback_nav_start(self, data):
        self.graph_flag = True
        print("called service of nav_cloning")
